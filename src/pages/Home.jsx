...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-950 relative">
            ...
            {/* Hero Section */}
            <div className="relative z-10 pt-16 pb-20 px-4 sm:pt-24 sm:pb-32 lg:pt-32 lg:pb-40">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center">
                        ...
                        <div className="max-w-2xl mx-auto px-4">
                            <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-800/50 shadow-2xl">
